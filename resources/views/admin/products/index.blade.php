                ...
                <div class="flex flex-col md:flex-row gap-4">
                    <div class="flex-1 flex flex-col md:flex-row gap-4">
                        <div class="relative flex-1">
                            ...
                            <input type="text" value="{{ request('search') }}" name="search" placeholder="Search products..." 
                        ...
                        <select name="category" class="px-4 py-2.5 rounded-lg border border-amber-200 focus:ring-2 focus:ring-amber-300 focus:border-amber-300 outline-none transition">
                            ...
                            <option value="merch" {{ request('category') == 'merch' ? 'selected' : '' }}>Merchandise</option>
                             <option value="kape" {{ request('category') == 'kape' ? 'selected' : '' }}>Kape</option>
                        </select>
                    </div>
                    
                    <button type="submit" class="bg-amber-700 hover:bg-amber-800 text-white px-6 py-2.5 rounded-lg transition-all duration-200 font-semibold flex items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
